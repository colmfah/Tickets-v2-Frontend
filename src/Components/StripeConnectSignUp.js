...
componentDidMount(){
	...
	render() {
	  ...
	  return (
			...
			{(this.state.error === false && this.state.code === false && this.state.readAndWrite === false)? <div>
							...
							<p>If you don't have a Stripe account, you can fill in the details on the page to create one, or alternatively, visit <a href='https://dashboard.stripe.com/register' target="_blank">www.stripe.com</a> to create one.</p>
							</div>
